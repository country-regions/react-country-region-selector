...
var RegionDropdown = function (_React$Component2) {
  ...
  function RegionDropdown(props) {
    ...
    _this3.state = { regions: _this3.getRegions(props.country), selectedValue: '' };
  ...
  _createClass(RegionDropdown, [{
    ...
    value: function getRegionList() {
      ...
      return this.state.regions.map(function (_ref3) {
        ...
        if (isMaterial) {
          return _react2.default.createElement(_MenuItem2.default, { value: value, key: regionName,
            primaryText: label });
        }
    ...
    value: function render() {
      ...
      if (isMaterial) {
        ...
        return _react2.default.createElement(_SelectField2.default, _extends({}, attrs, { value: this.state.selectedValue }), this.getDefaultOption(), this.getRegionList());
      } else {
        attrs.onChange = function (e) {
