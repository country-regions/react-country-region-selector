    ...
    value: function render() {
      ...
      if (isMaterial) {
        attrs.onChange = function (event, index, value) {
          ...
          console.log(_this4.state.selectedRegion, value, selectedRegion);
          _onChange2(value);
        };
        return _react2.default.createElement(_SelectField2.default, _extends({}, attrs, { value: selectedRegion }), this.getDefaultOption(), this.getRegionList());
      } else {
