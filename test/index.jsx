...
import { CountryRegionsHelper, CountryDropdown, RegionDropdown } from "../dist/react-crs";
...
//        <RegionDropdown value={region} onChange={(val) => this.selectCountry(val)} />
//      </div>
//    );
//  }
//}
...
ReactDOM.render(<SimpleExample />, appRoot);
